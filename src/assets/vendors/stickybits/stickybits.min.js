...
! function(t, s) {
    ...
    var e = function() {
        function t(t, s) {
            var e = void 0 !== s ? s : {};
            this.version = "3.6.1", this.userAgent = window.navigator.userAgent || "no `userAgent` provided by the browser", this.props = {
            ...
            for (var f = 0; f < this.els.length; f++) {
                var p = this.els[f];
                if (p.style[o] = c, p.style.position = u, "fixed" === n || l) {
                    var h = this.addInstance(p, this.props);
        ...
        return s.definePosition = function() {
            ...
            var s = t,
                ...
                u = l + n.offsetHeight;
            return s.offset = a + e.stickyBitStickyOffset, s.stickyStart = r ? l - s.offset : 0, s.stickyChange = s.stickyStart + c, s.stickyStop = r ? u - (i.offsetHeight + s.offset) : u - window.innerHeight, s
            ...
            var s = t,
                ...
                S = k && C <= o && ("sticky" === n || "stuck" === n),
                w = a <= C && "sticky" === n;
            o < C && C < a && ("default" === n || "stuck" === n) ? (s.state = "sticky", g(function() {
                v(e, d, p), l.position = u, c || (l.bottom = "", l[y] = i.stickyBitStickyOffset + "px")
            })) : S ? (s.state = "default", g(function() {
                v(e, p), v(e, d), "fixed" === u && (l.position = "")
            })) : w && (s.state = "stuck", g(function() {
                v(e, p, d), "fixed" !== u || c || (l.top = "", l.bottom = "0", l.position = "absolute")
            }));
            var b = r <= C && C <= a;
            return C < r / 2 || a < C ? g(function() {
                v(e, h)
            }) : b && g(function() {
                v(e, "stub", h)
            }), s
